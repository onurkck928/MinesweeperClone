...
#include "../../../../2022400141_2022400153/minesweeper/cell.h"
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->wonGame(); break;
        case 1: _t->lostGame(); break;
        case 2: _t->revealCell(); break;
        case 3: _t->flagCell(); break;
        default: ;
        }
        ...
        {
            using _t = void (Cell::*)();
            if (_t _q_method = &Cell::wonGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Cell::*)();
            if (_t _q_method = &Cell::lostGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
